...
interface TransportStepProps {
  inputs: CarbonInputs;
  onChangeNumber: (field: keyof CarbonInputs, value: string) => void;
  onChangeSelect: (field: keyof CarbonInputs, value: string) => void;
}
...
const IntroStep: React.FC<IntroStepProps> = ({ onBegin }) => {
  return (
...
const TransportStep: React.FC<TransportStepProps> = ({ inputs, onChangeNumber, onChangeSelect }) => {
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-lg)' }} className="form-grid">
        <div className="form-group">
          ...
          <select
            ...
            onChange={(e) => onChangeSelect('carFuelType', e.target.value)}
          >
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => onChangeNumber('carKm', e.target.value)}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-lg)' }} className="form-grid">
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => onChangeNumber('flightsShort', e.target.value)}
            placeholder="e.g. 4"
            min="0"
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => onChangeNumber('flightsLong', e.target.value)}
            placeholder="e.g. 12"
            min="0"
          />
        </div>
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => onChangeNumber('transitHours', e.target.value)}
...
const EnergyStep: React.FC<EnergyStepProps> = ({ inputs, onChangeNumber, onChangeSelect }) => {
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-lg)' }} className="form-grid">
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => onChangeNumber('electricityKwh', e.target.value)}
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => onChangeNumber('greenEnergyPercent', e.target.value)}
          />
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-lg)' }} className="form-grid">
        <div className="form-group">
          ...
          <select
            ...
            onChange={(e) => onChangeSelect('heatingFuel', e.target.value)}
          >
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => onChangeNumber('heatingKwh', e.target.value)}
            placeholder="e.g. 300"
...
const LifestyleStep: React.FC<LifestyleStepProps> = ({ inputs, onChangeNumber, onChangeSelect }) => {
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-lg)' }} className="form-grid">
        <div className="form-group">
          ...
          <select
            ...
            onChange={(e) => onChangeSelect('dietType', e.target.value)}
          >
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => onChangeNumber('localFoodPercent', e.target.value)}
          />
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-lg)' }} className="form-grid">
        <div className="form-group">
          ...
          <select
            ...
            onChange={(e) => onChangeSelect('shoppingHabits', e.target.value)}
          >
        ...
        <div className="form-group">
          ...
          <select
            ...
            onChange={(e) => onChangeSelect('wasteVolume', e.target.value)}
          >
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => onChangeNumber('recyclingRate', e.target.value)}
        />
      </div>
    </div>
  );
...
const CompletionStep: React.FC<CompletionStepProps> = ({ onRecalculate, onViewDashboard }) => {
  return (
    <div style={{ textAlign: 'center', padding: 'var(--spacing-md)' }}>
      <div 
        style={{
      ...
      <div className="glass-panel slide-up">
        ...
        {step === 4 && (
          <CompletionStep 
            ...
            onViewDashboard={() => onCalculate(inputs)} 
          />
        )}
      </div>
